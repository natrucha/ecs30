...
int main(int argc, char const *argv[]) {
  ...
  int repeat = 1; // determines if the program has to run again
  char another; // choice to do another conversion
  ...
  while (repeat == 1) {
    ...
    // make repeat 0 so that unless explicitly asked, the program ends
    repeat = 0;
